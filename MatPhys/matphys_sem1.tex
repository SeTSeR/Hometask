...
Начало в 12:15
\section{Семинар 2}
\label{sec:org08d0ba4}
\zall
\subsection{Уравнение теплопроводности}
\label{sec:orgca86393}
\begin{equation}
...
\end{equation}
\section{Семинар 5}
\label{sec:org226abdc}
\zall
\subsection{Задача 4.13}
\label{sec:org6083db2}
\begin{equation}
\begin{cases}
