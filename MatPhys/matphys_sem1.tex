...
Начало в 12:15
\section{Семинар 2}
\label{sec:org62beaae}
\zall
\subsection{Уравнение теплопроводности}
\label{sec:org92ea4bb}
\begin{equation}
...
\end{equation}
\section{Семинар 5}
\label{sec:orga4381ba}
\zall
\subsection{Задача 4.13}
\label{sec:org8de92c9}
\begin{equation}
\begin{cases}
