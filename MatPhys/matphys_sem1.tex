...
Начало в 12:15
\section{Семинар 2}
\label{sec:orge7c0e20}
\subsection{Уравнение теплопроводности}
\label{sec:orgff8030f}
\begin{equation}
...
\end{equation}
\section{Семинар 5}
\label{sec:org1fbcb48}
\subsection{Задача 4.13}
\label{sec:org0e03fea}
\begin{equation}
\begin{cases}
