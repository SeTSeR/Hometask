...
\label{sec:org47abede}
\subsubsection{Внутренняя задача Дирихле}
\label{sec:org9a2c926}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ в T}, \\
...
\label{sec:org245b176}
\begin{enumerate}
\item Трёхмерная задача
\label{sec:orgd2c788c}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ вне T}, \\
u|_{\Sigma} = g(p).
...
\label{sec:org244c753}
\begin{enumerate}
\item Внутренняя
\label{sec:org43efef9}
\begin{equation}
\begin{cases}
\Delta u = 0, r < a, \\
u|_{r = a} = f(\varphi).
