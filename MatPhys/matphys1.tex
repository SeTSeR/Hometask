...
\label{sec:org2ec6d5d}
\subsubsection{Внутренняя задача Дирихле}
\label{sec:org96bfef4}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ в T}, \\
...
\label{sec:orgf18d8d2}
\begin{enumerate}
\item Трёхмерная задача
\label{sec:org88dd7f0}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ вне T}, \\
u|_{\Sigma} = g(p).
...
\label{sec:orgd665e14}
\begin{enumerate}
\item Внутренняя
\label{sec:org7a23aa2}
\begin{equation}
\begin{cases}
\Delta u = 0, r < a, \\
u|_{r = a} = f(\varphi).
