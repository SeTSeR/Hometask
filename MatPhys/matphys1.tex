...
\label{sec:orgc83249b}
\subsubsection{Внутренняя задача Дирихле}
\label{sec:org06dabd2}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ в T}, \\
...
\label{sec:org4bc3296}
\begin{enumerate}
\item Трёхмерная задача
\label{sec:org45a7e87}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ вне T}, \\
u|_{\Sigma} = g(p).
...
\label{sec:orge95279d}
\begin{enumerate}
\item Внутренняя
\label{sec:org1d9ae18}
\begin{equation}
\begin{cases}
\Delta u = 0, r < a, \\
u|_{r = a} = f(\varphi).
