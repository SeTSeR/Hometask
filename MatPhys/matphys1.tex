...
\label{sec:org8f15536}
\subsubsection{Внутренняя задача Дирихле}
\label{sec:org8708b5b}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ в T}, \\
...
\label{sec:org7a1cae7}
\begin{enumerate}
\item Трёхмерная задача
\label{sec:orgbf22367}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ вне T}, \\
u|_{\Sigma} = g(p).
...
\label{sec:org5698a22}
\begin{enumerate}
\item Внутренняя
\label{sec:orge5d9d90}
\begin{equation}
\begin{cases}
\Delta u = 0, r < a, \\
u|_{r = a} = f(\varphi).
