...
\label{sec:org13e0795}
\subsubsection{Внутренняя задача Дирихле}
\label{sec:org41f1c19}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ в T}, \\
...
\label{sec:orge431fc8}
\begin{enumerate}
\item Трёхмерная задача
\label{sec:org90f2893}
\begin{equation}
\begin{cases}
\Delta u = 0 \text{ вне T}, \\
u|_{\Sigma} = g(p).
...
\label{sec:orgd6f0e9d}
\begin{enumerate}
\item Внутренняя
\label{sec:org66b0f9d}
\begin{equation}
\begin{cases}
\Delta u = 0, r < a, \\
u|_{r = a} = f(\varphi).
